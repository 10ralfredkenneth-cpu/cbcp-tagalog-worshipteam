...
function SongLibraryPage() {
  ...
  return <main className="container mx-auto px-3 sm:px-6 py-8 md:py-16">
    <header className="max-w-4xl mx-auto mb-7 md:mb-10 text-center"><h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-foreground mb-3 md:mb-5">Worship Song Library</h1><p className="text-sm sm:text-lg text-muted-foreground">Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required. Implement a song detail modal or dedicated page that shows lyrics, metadata, and the cover art with better mobile layout.</p></header>
